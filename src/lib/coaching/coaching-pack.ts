  ...
  return {
    ...
    scheduleTemplates: [
      {
        ...
        dayType: "training",
        summary: "Pressing-focused day for chest fullness, delt shape, and controlled upper-body output.",
        details: [
      ...
      },
      {
        title: "Back + arms",
        dayType: "training",
        summary: "Back width, rowing volume, and direct arm work in one focused session.",
        details: [
      ...
      },
      {
        title: "Legs",
        dayType: "training",
        summary: "Single lower-body day built around quads, hamstrings, calves, and a controlled LISS finish.",
        details: [
      ...
      },
      {
        title: "Chest + back",
        dayType: "training",
        summary: "Second chest exposure paired with back volume to keep the upper body full while cutting.",
        details: [
          "Machine chest press 3 x 10-12",
          "Neutral pulldown 3 x 10-12",
      ...
      },
      {
        ...
        dayType: "training",
        summary: "Delt and arm-focused day with enough direct volume to support the look without dragging recovery down.",
        details: [
          "Machine shoulder press 3 x 8-10",
          "Cable lateral raise 3 x 12-20",
      ...
      },
      {
        ...
        dayType: "conditioning",
        summary: "Third formal cardio exposure of the week without adding another lifting day.",
        details: [
          "Treadmill LISS 20-25 minutes",
          "10k+ steps",
    ...
    nutritionSections: [
      ...
      },
      {
        ...
        bullets: [
          "Meal 1: Protein bar for breakfast. Keep it simple and use a bar that fits the calories cleanly.",
          "Meal 2: Grilled chicken, chicken sausage, 90/10 ground beef, eggs + egg whites, tilapia, or cod with broccoli, cauliflower, carrots, lettuce, or salad.",
          "Meal 3: One of the same protein options with vegetables plus a smaller rice serving or a 60-80 calorie fiber tortilla.",
          "Meal 4 / snack: Fat-free Greek yogurt with berries. Strawberries, blueberries, blackberries, and raspberries all work.",
          "Meal 5: Lean protein again with salad or vegetables. Add a measured fat source only if needed to fit the day.",
        ],
      },
      {
        heading: "Food-source list",
        bullets: [
          "If a meal has to change, keep the day near 180 g protein, 180 g carbs, and 60 g fat.",
          "Protein sources: grilled chicken, chicken sausage, 90/10 ground beef, eggs, egg whites, tilapia, cod, and protein bars when needed for convenience.",
          "Carb and volume sources: broccoli, cauliflower, carrots, lettuce, salad, a smaller rice serving, and 60-80 calorie fiber tortillas.",
          "Snack option: fat-free Greek yogurt with berries.",
          "Fat sources: a measured portion of nuts or avocado is fine. Keep these controlled because the calories climb quickly.",
